...
namespace Eggmania
{
    public partial class App : Application
    {
        ...
        public static List<MainMenuModel> mainMenuItems = new List<MainMenuModel>();
        public static List<AddOn> addOnList = new List<AddOn>();
        public static List<MenuItemModel> menuItemsList = new List<MenuItemModel>();
        public static DbFirebase db = new DbFirebase();
        public App()
        {
            InitializeComponent();
            MainPage = new NavigationPage(new Login());
            mainMenuItems = Task.Run(db.getCategories).Result;
            addOnList = Task.Run(db.getAddOns).Result;
            menuItemsList = Task.Run(db.getMenuItems).Result;



            //One time code for generating datas
            //db.saveCategories();
            //db.saveAddOnItems();
            //db.saveMenuItemEggSamplers();
        }
